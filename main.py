...
class Events(pygame.sprite.Sprite):
    def __init__(self, *groups):
        ...
        self.score = 0
        self.lives = 4
        self.high_score_file = open('high_score.txt')
    ...
    def show_high_score(self):
        high_score_text = self.font.render(f'high score: {self.high_score}', False, 'white')
        screen.blit(high_score_text, (300, 425))
...
while True:
    ...
    if game_active:
        ...
        if my_events.lives == 0:
            my_events.game_over_screen()
        else: 
            my_events.start_game_screen()
